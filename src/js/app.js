...
const App = {
    ...
    data: {
        email: "ankitpandey.anp@gmail.com",
        snippet: `// WordPress development philosophy
const build = (site) => ({
  custom: true,
  scalable: true,
  security: "enforced",
        ...
        skills: [
            {
                ...
                name: "WordPress",
                pct: 95,
                tags: ["Custom Themes", "Plugins", "Multisite"],
            },
            {
                group: "frontend",
                ...
                name: "Elementor",
                pct: 92,
                tags: ["Custom Widgets", "Templates", "UI"],
            },
            {
                group: "frontend",
...

            {
                ...
                name: "PHP",
                pct: 94,
                tags: ["WordPress Core", "Hooks", "APIs"],
            },
            {
                group: "backend",
                ...
                name: "Node.js",
                pct: 85,
                tags: ["REST APIs", "Express", "Automation"],
            },
            {
                group: "backend",
                ...
                name: "MySQL",
                pct: 90,
                tags: ["Queries", "Optimization", "Schema"],
            },
            {
                group: "backend",
                ...
                name: "Security",
                pct: 87,
                tags: ["Cybersecurity", "Auth", "Access Control"],
            },
            ...
            },
            {
                ...
                name: "Linux/Server",
                pct: 88,
                tags: ["Ubuntu", "Windows Server", "Networking"],
            },
            {
                group: "tools",
        ...
        timeline: [
            {
                ...
                org: "Twinspark Technology Pvt. Ltd.",
                period: "Jan 2022 - Present",
                icon: "fa-solid fa-briefcase",
                bullets: [
                    "Built custom WordPress themes and Understrap hybrid themes with dynamic headers, footers, and global/local Elementor widgets.",
                    "Developed custom Elementor widgets using repeaters, tabs, accordions, and template-based rendering with video and audio support.",
                    "Implemented automation for multi-page form submissions across 250+ websites using AI-powered scripting.",
                    "Created advanced frontend components including Swiper sliders with multiple rows, pagination, looping, and mega menu integration.",
                    "Developed and integrated custom CRM plugins; handled authentication and data management using MySQL and PostgreSQL.",
                    "Managed multisite WordPress setups and third-party plugin integrations such as Gravity Forms and Google Maps API.",
                ],
            },
            {
                role: "EDP Manager",
                org: "Sunny Toyota Private Limited",
                period: "Jan 2019 - Apr 2020",
                icon: "fa-solid fa-desktop",
                bullets: [
                    "Developed and executed training programs for staff on EDP tools and internal software systems.",
                    "Streamlined reporting processes to ensure accurate and timely data dissemination across departments.",
                    "Implemented cybersecurity best practices to protect company data from unauthorized access and breaches.",
                    "Led and mentored a team of IT professionals, providing technical support and process improvements.",
                ],
            },
            {
                role: "Network Engineer",
                org: "Progressive Infotech Private",
                period: "Jun 2014 - Mar 2016",
                icon: "fa-solid fa-network-wired",
                bullets: [
                    "Designed and implemented secure network infrastructure for multiple client environments.",
                    "Monitored system performance and network capacity to ensure high availability and reliability.",
                    "Configured and supported networking hardware including switches, routers, hubs, and firewalls.",
                    "Implemented VPN infrastructure to enable secure remote access for users.",
                ],
            },
            {
                role: "Senior Service Desk Engineer",
                org: "HCL Services Ltd. (HCL Technologies)",
                period: "Jun 2012 - Mar 2014",
                icon: "fa-solid fa-headset",
                bullets: [
                    "Provided advanced technical support for desktop systems, operating systems, applications, and network connectivity issues.",
                    "Managed and resolved escalated incidents while coordinating with stakeholders to ensure timely resolution.",
                    "Supported remote users using remote desktop tools, resolving connectivity and system-related issues efficiently.",
                    "Removed malware, ransomware, and security threats; applied patches and software updates to ensure system security.",
                ],
            },
        ],
        projects: [
            {
                title: "Multi-Site WordPress Automation",
                desc: "Automated form submission system across 250+ WordPress websites with AI-powered scripting and CRM integration.",
                cover: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1400&q=70",
                stack: ["WordPress", "PHP", "Node.js", "AI Scripts"],
                meta: "Focus: automation + scalability • Outcome: 250+ sites managed efficiently",
                bullets: [
                    "Built intelligent automation system for multi-page form submissions.",
                    "Integrated AI-powered scripting to handle complex form workflows.",
                    "Reduced manual processing time by 90% across all managed sites.",
                ],
                links: [
                    {
                        label: "View Demo",
            ...
            {
                title: "Custom Elementor Widget Library",
                desc: "Advanced Elementor widgets with repeaters, tabs, accordions, Swiper sliders, and multimedia support.",
                cover: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=1400&q=70",
                stack: ["WordPress", "Elementor", "PHP", "JavaScript"],
                meta: "Focus: UI flexibility + reusability • Outcome: powerful widget toolkit",
                bullets: [
                    "Developed custom widgets with advanced features like repeaters and tabs.",
                    "Implemented Swiper sliders with multiple rows, pagination, and looping.",
                    "Created template-based rendering system with video and audio integration.",
                ],
                links: [
                    {
                        label: "Documentation",
            ...
            },
            {
                ...
                desc: "WordPress plugin for seamless CRM integration with secure authentication and multi-database support.",
                cover: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1400&q=70",
                stack: ["PHP", "MySQL", "PostgreSQL", "REST APIs"],
                meta: "Focus: security + data integrity • Outcome: robust CRM bridge",
                bullets: [
                    "Built secure authentication system for CRM data exchange.",
                    "Handled complex data management across MySQL and PostgreSQL.",
                    "Implemented webhook-based real-time synchronization.",
                ],
                links: [
                    {
                        label: "Case Study",
            ...
            {
                title: "Understrap Hybrid Theme Framework",
                desc: "Custom WordPress theme combining Understrap with dynamic Elementor integration for flexible site building.",
                cover: "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=1400&q=70",
                stack: ["WordPress", "Understrap", "Elementor", "PHP"],
                meta: "Focus: flexibility + performance • Outcome: scalable theme system",
                bullets: [
                    "Built hybrid architecture with dynamic headers and footers.",
                    "Integrated global and local Elementor widget support.",
                    "Optimized for performance with lazy loading and WebP image conversion.",
                ],
                links: [
                    {
                        label: "Documentation",
